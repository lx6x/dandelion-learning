...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(
                        "jdbc:mysql://192.168.192.128:3306/dandelion_flowable?useSSL=false&autoReconnect=true&characterEncoding=utf8",
                        "root",
                        "root")
                // 全局配置
...
//                                .enableSwagger() // 开启 swagger 模式
                                        .enableSpringdoc()
                                        .outputDir(userDir + "/dandelion-flowable/src/main/java") // 指定生成目录
